...
func TestLexerKeywords(t *testing.T) {
	input := "fn do var mut return end char int bool unit string float if then else struct is importc while null"
	...
	want := "kw_fn kw_do kw_var kw_mut kw_return kw_end kw_char kw_int kw_bool kw_unit kw_string kw_float kw_if kw_then kw_else kw_struct kw_is kw_import kw_while kw_null eof"
